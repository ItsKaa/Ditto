...
namespace Ditto.Bot.Services
{
    public partial class CommandHandler : IDisposable
    {
        ...
        {	
            // Load our modules
            var internalModules = GetModules().ToList();
            ...
            foreach (var method in EnumerateMethods(internalModules))
            {
			...
			//Console.WriteLine("{0}:{1}", guildId, internalModules.Count);
        }

        private IEnumerable<ModuleMethod> EnumerateMethods(IEnumerable<ModuleInfo> modules, ModuleInfo moduleInfo = null)
        {
        ...
        private Task MessageReceivedHandler(SocketMessage socketMessage)
        {
            ...
            {	
                ...
                if (parseResult != null)
                {
                    ...
                    await ExecuteMethodAsync(context, parseResult.Method.MethodInfo, params1d);
                }
        ...
        protected static MethodInfo FindMethodInfo(ModuleInfo moduleInfo, string commandString)
    ...
    public partial class CommandHandler
    {
        ...
        private static IEnumerable<ModuleInfo> GetModules(Type baseType = null)
        {
            if (baseType == null)
            {
        ...
        private static List<ModuleMethod> GetMethods(Type type)
        {
